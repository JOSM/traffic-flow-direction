...
import org.openstreetmap.josm.plugins.directionofflow.gui.details.filter.FilterDialog;
...
/**
 * Defines the button panel for the direction of flow details panel.
 *
 * @author Beata
 * @version $Revision: 28 $
 */
class ButtonPanel extends JPanel {
    ...
    ButtonPanel() {
        ...
        btnComment = GuiBuilder.buildButton(
                new DisplayEditDialog(null, guiCnf.getDlgCommentTitle(), iconCnf.getCommentIcon()),
    ...
    private class DisplayEditDialog extends AbstractAction {
