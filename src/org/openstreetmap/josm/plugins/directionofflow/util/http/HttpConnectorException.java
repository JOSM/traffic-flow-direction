...
/**
 * Custom exception used for HTTP communication errors.
 *
 * @author Beata
 * @version $Revision: 2 $
 */
public class HttpConnectorException extends Exception {
    ...
    private static final long serialVersionUID = -3734947979808126320L;
     ...
     */
    public HttpConnectorException(final String msg) {
        super(msg);
    }
     ...
     */
    public HttpConnectorException(final String msg, final Throwable cause) {
        super(msg, cause);
    }
